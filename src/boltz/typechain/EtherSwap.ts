...
export interface EtherSwapInterface extends utils.Interface {
  functions: {
    "claim(bytes32,uint256,address,uint256)": FunctionFragment;
    "hashValues(bytes32,uint256,address,address,uint256)": FunctionFragment;
    "lock(bytes32,address,uint256)": FunctionFragment;
    "lockPrepayMinerfee(bytes32,address,uint256,uint256)": FunctionFragment;
    "refund(bytes32,uint256,address,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "Lockup(bytes32,uint256,address,address,uint256)": EventFragment;
...
export interface EtherSwap extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EtherSwapInterface;
